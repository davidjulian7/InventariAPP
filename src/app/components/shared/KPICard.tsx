...
export function KPICard({ title, value, subtitle, icon: Icon, trend, accentColor = false, compact = false }: {
  title: string; value: string; subtitle?: string; icon: React.ElementType; trend?: number; accentColor?: boolean; compact?: boolean
}) {
  return (
